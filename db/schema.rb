...
ActiveRecord::Schema.define(version: 20170710191143) do
  ...
  add_index "spree_refunds", ["payment_id"], name: "index_spree_refunds_on_payment_id"
  add_index "spree_refunds", ["refund_reason_id"], name: "index_refunds_on_refund_reason_id"
  add_index "spree_refunds", ["reimbursement_id"], name: "index_spree_refunds_on_reimbursement_id"
