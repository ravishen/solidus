# -*- encoding: utf-8 -*-
# stub: state_machines-activerecord 0.5.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/state-machines/state_machines-activerecord/"
  s.licenses = ["MIT"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<state_machines-activemodel>, [">= 0.5.0"])
      s.add_runtime_dependency(%q<activerecord>, ["< 5.2", ">= 4.1"])
      ...
      s.add_dependency(%q<state_machines-activemodel>, [">= 0.5.0"])
      s.add_dependency(%q<activerecord>, ["< 5.2", ">= 4.1"])
